...
class WriteTest {
    ...
    void shouldWrite() throws Exception {
        stubFor(
            put(urlEqualTo("/accounts/test-account/storage/kv/namespaces/ns_123/bulk"))
        ...
        verify(
            putRequestedFor(urlEqualTo("/accounts/test-account/storage/kv/namespaces/ns_123/bulk"))
